...
# --- ЗОБРАЖЕННЯ ----
ball_img = image.load("stam2-removebg-preview.png").convert_alpha()
ball_img = transform.scale(ball_img, (50, 50))
background_img = image.load("happy.jpg").convert()
background_img = transform.scale(background_img, (800, 600))
# --- ЗВУКИ ---
sound_wall = mixer.Sound("Selo.mp3")
sound_platform = mixer.Sound("yay.mp3")
# --- ГРА ---
game_over = False
winner = None
you_winner = None
...
while True:
    ...
    if game_state:
        screen.blit(background_img, (8,0))
        draw.rect(screen, (0, 255, 0), (20, game_state['paddles']['0'], 20, 100))
        draw.rect(screen, (255, 0, 255), (WIDTH - 40, game_state['paddles']['1'], 20, 100))
        draw.circle(screen, (255, 255, 255), (game_state['ball']['x'], game_state['ball']['y']), 10)
        score_text = font_main.render(f"{game_state['scores'][0]} : {game_state['scores'][1]}", True, (255, 255, 255))
        screen.blit(score_text, (WIDTH // 2 -25, 20))
        ball_rect = ball_img.get_rect(center=(game_state['ball']['x'], game_state['ball']['y']))
